...
const AddItem = ({ close, categoryId, closeAddItem }) => {
  ...
  const onSubmit = (values) => {
    ...
    form.append("calories", values.calories)
        ...
        axios.post("https://victorious-pink-turtleneck-shirt.cyclic.app/controlboard/createItem",form).then((res)=>{
            if(res.data.success){
  ...
  return (
    <div className="fixed inset-x-0 top-0 w-full h-full backdrop-blur-sm bg-gray/30 z-50">
      <div className="flex flex-col gap-2  bg-white py-10  shadow-xl w-full md:w-[80%] lg:w-[60%] fixed right-0 top-0 z-50 h-full ">
        ...
        <form
          className="flex flex-col justify-between gap-5 w-full mt-10 overflow-hidden px-6 h-full font-semibold text-xl"
          ...
          <div className="flex flex-col gap-10 w-full  overflow-y-auto px-6">
            <div className="flex flex-col gap-2 w-full">
              ...
              <input
                ...
                className={`py-3 px-4 rounded-full border outline-none ${
                  errors?.itemName
                ...
                <div className="flex flex-col gap-2 w-full">
                  ...
                  <div className="w-full relative">
                    <input
                      ...
                      className={`py-3 px-4 rounded-full w-full border outline-none ${
                        errors?.price
                          ? "bg-red-100 border-red-300"
                          : "bg-gray-100   border-gray-300"
                      }`}
                    />
                    <p className="absolute left-[0px] inset-y-0 rounded-l-full py-3 px-6 bg-gray-300 font-semibold">
                      SAR
                    </p>
                  </div>
                  {errors?.price && (
            ...
            <div className="flex flex-col gap-2 w-[80%] md:w-[60%]">
              ...
              />
              <small className="text-xs pr-4">هذا الحقل اختياري</small>
            </div>
          </div>
          <div className="flex justify-end gap-3 items-center">
            <button
              className="text-red-500 hover:text-red-600 bg-transparent"
              onClick={() => closeAddItem(false, "تم تجاهل اضافه تصنيف")}
            >
              تجاهل
            </button>
            <form
            ...
            >
              ...
              <div className="flex justify-end gap-3 items-center">
                ...
                <input
                  type="submit"
                  value="حفظ"
                  className="bg-blue-500 hover:bg-blue-700 w-[80px] text-white py-2 rounded-full cursor-pointer"
                />
              </div>
            </form>
          </div>
